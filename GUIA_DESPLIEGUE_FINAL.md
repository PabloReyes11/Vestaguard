...
```cmd
cd "C:\Users\PR11\OneDrive\Documentos\7MO-SEM\Sistemas Programables\Unidad 4\Proyecto_Final_\DESPLIEGUE\Servidor"
...
```cmd
cd "C:\Users\PR11\OneDrive\Documentos\7MO-SEM\Sistemas Programables\Unidad 4\Proyecto_Final_\DESPLIEGUE\docs"
...
1. **Desde tu Laptop:** Abre tu navegador y entra a `http://localhost:8080/index.html`
2. **Desde tu Celular:** Asegúrate de estar en la misma red Wi-Fi que la laptop y entra a la dirección oficial: **`http://10.254.179.79:8080/index.html`**
