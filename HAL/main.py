"""
OBJETIVO: Archivo principal de ejecucion para la Maquina de Estados del chaleco VestaGuard.
SE CARGA EN: ESP32 principal del chaleco.
RESPONSABLE PRINCIPAL: Reyes Gutierrez Pablo Alberto.
APOYO DE LECTURA: Aldo Rangel (telemetria) y Estefania Alvarez (interaccion con camara).
